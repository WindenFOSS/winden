...
function WelcomeModal({ isOpen, onClose }) {
  ...
  const handleClose = () => {
    if (dontShowAgain) {
      localStorage.setItem('windenWelcomeShown', 'true');
    }
    onClose();
  };
      ...
      <DialogContent className="max-w-2xl">
        <div className="py-10">
          <div className="relative space-y-4">
            <img src="https://i.postimg.cc/bwfSP5pR/nopb-logo.png" alt="Winden Logo" className="w-auto h-12 mb-6" />
            <h2 className="text-3xl font-bold text-black">Winden 0.1 (Aurora)</h2>
            <p className="text-neutral-700 max-w-lg">
              The next generation of Winden is here. New year, new look, new features and improvements. We're excited to have you join us for this new experience!
            </p>
...
export default function AdminOverview() {
  const [showWelcome, setShowWelcome] = useState(() => {
    return !localStorage.getItem('windenWelcomeShown');
  });
