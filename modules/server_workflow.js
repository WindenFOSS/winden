...
module.exports.load = async function (app, db) {
  ...
  function executePowerAction(instanceId, action) {
    try {
      fetch(`${settings.pterodactyl.domain}/api/client/servers/${instanceId}/power`, {
        method: "POST",
        headers: {
      ...
      }).catch(err => console.error(`Failed to execute power action: ${err}`));
    } catch (error) {
